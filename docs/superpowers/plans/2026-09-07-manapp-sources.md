...
### Task 1: Scaffold Cargo dan kontrak model melalui test
...
- [ ] **Step 5: Commit the scaffold and model contract**
...
### Task 4: Build the Sources page and UI state
...
- [ ] **Step 4: Run automated tests and manual smoke test**
...
- [ ] **Step 1: Install the coverage tool if missing**

  Run: `cargo install cargo-llvm-cov --locked`.

- [ ] **Step 2: Measure the current coverage**
...
- [ ] **Step 3: Add tests for uncovered behavior before changing production code**
...
- [ ] **Step 5: Commit coverage improvements**
...
- [ ] **Step 1: Verify the replacement before deletion**
...
- [ ] **Step 4: Commit the removal separately**
